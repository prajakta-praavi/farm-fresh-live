...
export const testimonials = [
  ...
  },
  {
    ...
    location: "Mumbai",
    text: "Rushivan Farm Stay has been an amazing and raw experience of nature. We celebrated a friend's bachelorette here and had lots of fun. All thanks to Bhagwan and Shanta Aunty for the incredible food and hospitality!",
    rating: 5,
  },
  {
    name: "Nivedita Kambale",
    location: "Pune",
    text: "The aroma of this Rushivan Desi Ghee takes me back to my childhood! It has that authentic, grainy texture and rich smell that you just don't find in store-bought brands. Truly pure and delicious.",
    rating: 5,
  },
  {
    name: "Rohini Pawar",
  ...
  },
  {
    name: "Jyoti Pathak",
    location: "Mumbai",
    text: "My grandchildren absolutely loved the organic strawberries from Rushivan. It is a relief knowing they are eating fruit grown without any harsh chemicals.",
    rating: 5,
  },
  {
    name: "Vijay Pachpute",
  ...
  },
  {
    ...
    location: "Pune",
    text: "I always prefer organic, and Rushivan's strawberries did not disappoint. They are the perfect healthy snack for our family. Highly recommended for anyone who loves real, farm-fresh fruit!",
    rating: 5,
  },
];
