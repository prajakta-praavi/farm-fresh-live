...
const Footer = () => {
  return (
    <footer className="text-foreground">
      ...
      >
        ...
        <div className="container relative z-10 pb-0 pt-10 md:pt-12">
          <div className="grid grid-cols-1 items-start gap-8 md:grid-cols-2 lg:grid-cols-4">
            <div className="flex h-full flex-col items-start pb-6 md:pb-8">
              <img
                src={rushivanLogo}
                alt="Rushivan Agro"
                className="mb-5 block h-20 w-[250px] max-w-full object-contain object-left"
              />
            ...
            <div className="flex h-full flex-col pb-6 md:pb-8">
              <h3 className="mb-4 min-h-[44px] text-2xl font-bold text-[#2f9b66] md:text-3xl">Quick Links</h3>
            ...
            <div className="flex h-full flex-col pb-6 md:pb-8">
              <h3 className="mb-4 min-h-[44px] text-2xl font-bold text-[#2f9b66] md:text-3xl">Contact Details</h3>
            ...
            <div className="flex h-full flex-col pb-6 md:pb-8">
              <h3 className="mb-4 min-h-[44px] text-2xl font-bold text-[#2f9b66] md:text-3xl">Location</h3>
              <div className="overflow-hidden rounded-md border border-[#9ec4d2] bg-white shadow-sm">
                <iframe
                  title="Rushivan Agro Location"
      ...
      <div className="-mt-[2px] bg-[#2f9b66] py-4 text-center">
        <p className="px-4 text-sm font-semibold text-[#ffffff] md:text-lg !text-center">
          Copyright &copy;2025 All Rights Reserved By Rushivan Agro Tourism Designed By{" "}
