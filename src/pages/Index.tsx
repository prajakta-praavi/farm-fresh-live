...
import farmProductsImage from "@/assets/farm-products.jpg";
...
const bannerSlides = [
  {
    ...
    description:
      "Enjoy chemical-free produce grown with care and healthy living from Rushivan Agro.",
...
const Index = () => {
  ...
  useEffect(() => {
    document.title = "Rushivan Agro Tourism | Pure by Nature, Rooted in Tradition.";
  }, []);
  ...
  return (
    <Layout>
        ...
        <div className="container">
          ...
          <div className="grid items-center gap-8 lg:grid-cols-2 lg:gap-12">
            ...
            <div className="flex justify-center lg:justify-end">
              <img
                src={aboutHomeImage}
                alt="About Rushivan Agro Tourism"
      ...
      <section className="py-10 md:py-14 bg-primary/5">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-display font-bold mb-3">Why Choose Rushivan Agro?</h2>
          </div>
      ...
      <section className="relative py-14 md:py-20 overflow-hidden">
        <div className="absolute inset-0">
          <img src={farmProductsImage} alt="" className="w-full h-full object-cover" />
